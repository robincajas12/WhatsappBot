...
import { MovieHandler } from './handlers/meHandlers/MovieHandler';
...
messageChain.setNext(new HelpHandler()).setNext(new HelloHandler()).setNext(new StickerHandler()).setNext(new PdfHandler()).setNext(new WeatherHandler()).setNext(new TodoHandler()).setNext(new NewsHandler()).setNext(new JokeHandler()).setNext(new MovieHandler());
